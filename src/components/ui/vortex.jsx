...
export const Vortex = (props) => {
  ...
  return (
    ...
    <div
      ...
      <div className=" flex sm:hidden pointer-events-none absolute inset-0  items-center justify-center  [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black) bg-black"></div>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ref={containerRef}
